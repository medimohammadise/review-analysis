...
@ComponentScan({"my.edu.um.fsktm"})
@EnableAutoConfiguration(exclude = {MetricFilterAutoConfiguration.class, MetricRepositoryAutoConfiguration.class})
@EnableConfigurationProperties({ApplicationProperties.class})
@EnableDiscoveryClient
public class AmazonreviewcollectorApp {

    private static final Logger log = LoggerFactory.getLogger(AmazonreviewcollectorApp.class);

    private final Environment env;

    public AmazonreviewcollectorApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AmazonreviewcollectorApp.class);
